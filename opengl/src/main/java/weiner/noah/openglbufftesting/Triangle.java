...
public class Triangle {
    ...
    public void draw(float[] mvpMatrix) { //pass in calculated transformation matrix  //WAS (float[] mvpMatrix)
        ...
        //set color for triangle -- values of RGB floats are between 0 and 1 inclusive
        ...
        //draw triangle -- Android tutorial version
    ...
    //actually draw the triangle on the display
    public void draw() { //pass in calculated transformation matrix  //WAS (float[] mvpMatrix)
