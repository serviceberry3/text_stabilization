...
extern "C" {
    ...
    JNIEXPORT jfloat Java_weiner_noah_ctojavaconnector_ImpulseResponse_impulse_1response_1arr_1get_1sum(JNIEnv *javaEnvironment, jclass __unused obj) {
        return impulseResponses->impulse_response_arr_get_sum();
    }

    JNIEXPORT jfloat Java_weiner_noah_ctojavaconnector_ImpulseResponse_impulse_1response_1arr_1get_1value(JNIEnv *javaEnvironment, jclass __unused obj, jint index) {
